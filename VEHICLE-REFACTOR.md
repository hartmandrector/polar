...
> **Status:** Architecture & Design Goals
> **Scope:** Blueprint for decoupling GLB models, aerodynamic polars, and mass systems
> **Related:** [REFERENCE-LENGTH.md](REFERENCE-LENGTH.md) (Phase A completed), [USER-MY-DATA.md](docs/USER-MY-DATA.md) (integration guide)
...
✅ Physics engine is unaware of vehicle identity:
  - All denormalization reads `vehicle.pilotHeight_m` or `polar.referenceLength_m`
  - No hardcoded constants
  - Same physics codepath for default vehicles + user vehicles

✅ GLB loading is deterministic:
  - No `parentScale * childScale` compensation
  - Scales derived from `physicalSize / glbMaxDim`
  - Test: change physical size, GLB loads at correct scale

✅ Aero + mass scale together:
